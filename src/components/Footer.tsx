...
const Footer = () => {
  const rehabCenters = [
    {
      name: "Kerala State Govt. De-addiction Centre",
      location: "Thiruvananthapuram",
      phone: "0471-2345678"
    },
    {
      name: "Navjeevan Trust Rehabilitation Centre",
      location: "Kochi",
      phone: "0484-2345678"
    },
    {
      name: "Sanjeevani Rehabilitation Centre",
      location: "Kozhikode",
      phone: "0495-2345678"
    },
    {
      name: "Ashraya Rehabilitation Centre",
      location: "Kollam",
      phone: "0474-2345678"
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="col-span-1">
            <h3 className="text-xl font-bold mb-4">Kerala Police</h3>
            <p className="mb-4">
              Working together for a drug-free Kerala. Your safety is our priority.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-white transition">Report Drug Activity</a></li>
            </ul>
          </div>

          <div className="col-span-1 lg:col-span-2">
            <h3 className="text-xl font-bold mb-4">Rehabilitation Centers</h3>
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-center text-sm">
          <p>© {new Date().getFullYear()} Kerala Police. All rights reserved.</p>
          <p className="mt-1">Together for a drug-free Kerala</p>
        </div>
      </div>
    </footer>
  );
